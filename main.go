...
func main() {
	...
	defer db.Close()
//	var tmpl, err = template.ParseGlob("views/*")  //parsing semua html di folder
...
func home(w http.ResponseWriter, r *http.Request) {
	...
	var t, err = template.ParseFiles("views/main_page.html","views/header_side.html","views/header_top.html","views/footer.html")
	if err != nil {
